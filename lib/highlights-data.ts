...
export const galleryItems: GalleryItem[] = [
  {
    ...
    description: 'Sabrang\'s grand runway event — haute couture meets the neon-lit catwalk in a spectacle of fashion and creative expression. Prize pool up to ₹40,000.',
  },
  {
    id: 2,
    ...
    description: 'The ultimate battle of bands — raw musical talent clashes under the spotlight as bands compete for sonic supremacy. Prize pool up to ₹25,000.',
  },
  {
    id: 3,
    ...
    description: 'High-energy dance crews go head-to-head in an explosive showcase of choreography and freestyle moves. Prize pool up to ₹35,000.',
  },
  {
    id: 4,
    ...
    description: 'Solo performers command the stage with technical mastery and artistic expression in this electrifying solo dance showdown. Prize pool up to ₹17,000.',
  },
  {
    id: 5,
    ...
    description: 'A soulful evening of classical music and traditional performances that illuminate the spirit of Indian artistry. Prize pool up to ₹17,000.',
  },
  {
    id: 6,
    ...
    description: 'Where words ignite — a celebration of poetry, shayari and spoken word that resonates long after the last verse.',
  },
  {
    id: 7,
    ...
    description: 'Canvas, colour, and creativity collide — artists bring their visions to life in a showcase of raw talent and imagination.',
  },
  {
    id: 8,
    ...
    description: 'Squad up and drop in — the most intense BGMI showdown on campus with glory and prizes on the line.',
  },
  {
    id: 9,
    ...
    description: 'Hands meet earth — sculpt, shape and create as raw clay transforms into works of art under the clock.',
  },
  {
    id: 10,
    ...
    description: 'The stage is yours — articulate, persuade, and captivate in this battle of wits and eloquence.',
  },
  {
    id: 11,
    ...
    description: 'Order in the court — argue your case, cross-examine witnesses, and deliver the verdict in this gripping mock trial.',
  },
  {
    id: 12,
    ...
    description: 'Negotiate, strategise, and close the deal — a high-stakes business simulation where every decision counts.',
  },
  {
    id: 13,
    ...
    description: 'No words, all action — act it out, guess fast, and let the laughter take over in this classic crowd favourite.',
  },
  {
    id: 14,
    ...
    description: 'See the world through a different lens — capture fleeting moments and tell stories that a thousand words cannot.',
  },
  {
    id: 15,
    ...
    description: 'Drop, loot, and survive — the ultimate Free Fire showdown where only the last squad standing claims victory.',
  },
  {
    id: 16,
    ...
    description: 'Clutch or kick — tactical precision meets raw aim in the most anticipated Valorant tournament of the fest.',
  },
  {
    id: 17,
    ...
    description: 'Boundaries, wickets, and glory — the cricket pitch comes alive as teams battle for the Sabrang trophy.',
  },
];
