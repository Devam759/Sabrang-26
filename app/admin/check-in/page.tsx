...
export default function QRCheckIn() {
  ...
  if (!user || role !== "admin")
    return <div className="text-center mt-20">Unauthorized</div>;
  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border space-y-8">
        <div
          id="reader"
          className="overflow-hidden rounded-xl border-4 border-slate-50"
        ></div>
      ...
      <div className="mt-8 bg-slate-50 p-6 rounded-2xl border border-dashed text-slate-500 text-xs leading-relaxed">
        <h3 className="font-bold mb-2 uppercase tracking-wider text-[10px] text-slate-400">
          Scanner Instructions
        </h3>
        <ul className="list-disc ml-4 space-y-1">
          <li>Ensure the QR code is clearly visible and well-lit.</li>
          <li>
            The system will automatically recognize the code and mark
            attendance.
          </li>
          <li>
            For manual entry, copy the unique string below the QR code in user
            dashboard.
          </li>
