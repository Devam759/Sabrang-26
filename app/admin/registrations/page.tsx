...
export default function AdminRegistrations() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h1 className="text-4xl font-black mb-10 text-slate-900 tracking-tight uppercase">
        Registrations
      </h1>
              ...
              >
                ...
                <td className="px-6 py-4 font-mono text-xs text-slate-400 uppercase tracking-widest">
                  ...
                  <div className="text-indigo-600 font-bold mt-0.5">
                    Ref: {reg.referralCode}
                  </div>
                </td>
                <td className="px-6 py-4">
                  {reg.attended ? (
                    <div className="flex flex-col">
                      <span className="bg-green-100 text-green-700 text-[10px] font-bold px-2 py-0.5 rounded-full w-fit uppercase mb-1">
                        Attended
                      </span>
