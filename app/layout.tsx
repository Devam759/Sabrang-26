...
export const metadata: Metadata = {
  ...
  description: "SABRANG 2026 - JK Lakshmipat University's premier annual cultural & technical fest. Experience Sabrang JKLU with star-studded pro-shows, flagship competitions, dance battles, and live concerts in Jaipur.",
  keywords: [
    'Sabrang 2026',
    'Sabrang JKLU',
    'Sabrang',
  ...
  twitter: {
    ...
    title: 'SABRANG 2026 | Sabrang JKLU | JK Lakshmipat University Fest',
    description: "SABRANG 2026 - JK Lakshmipat University's premier annual cultural & technical fest.",
