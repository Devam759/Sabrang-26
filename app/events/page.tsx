...
export const metadata: Metadata = {
  ...
  description: 'Explore the flagship events, competitions, pro-shows, Panache runway, Step-Up dance battles, and musical concerts at Sabrang 2026 JKLU.',
  keywords: [
    'Sabrang Events',
  ...
  openGraph: {
    title: 'Events & Competitions – Sabrang 2026',
    description: 'Explore flagship competitions, live pro-shows, and cultural battles at Sabrang 2026.',
