...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions regarding registrations, pass pickup, event slots, accommodation, and venue guidelines for Sabrang 2026 at JKLU.",
  keywords: [
    "Sabrang FAQ",
  ...
  openGraph: {
    title: "FAQ – Sabrang 2026",
    description:
      "Find answers to common questions about Sabrang 2026 registrations, schedules, and guidelines.",
