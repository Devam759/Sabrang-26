...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Sabrang 2026 will be held at JK Lakshmipat University, Mahapura, Ajmer Road, Jaipur, Rajasthan 302026.',
  },
  {
    ...
    <div className="relative min-h-screen py-12 px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          {faqs.map((faq, index) => (
            <details key={index} className="group bg-neutral-900/80 backdrop-blur-md border border-white/10 hover:border-white/30 rounded-2xl overflow-hidden transition-all duration-300">
