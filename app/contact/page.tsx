...
export const metadata: Metadata = {
  ...
  description:
    "Get in touch with the Sabrang 2026 organizing team. Reach out to our organizing heads or send an email to sabrang@jklu.edu.in.",
  keywords: [
    "Contact Sabrang",
  ...
  openGraph: {
    title: "Contact Us | Sabrang 2026",
    description:
      "Connect with the Sabrang 2026 organizing heads and festival committee.",
...
export default function ContactPage() {
  const jsonLdData = {
    ...
    description:
      "Contact details for Sabrang 2026 organizing heads and official helpdesk.",
    url: "https://sabrang.jklu.edu.in/contact",
  };
