        ...
        <div key={block.label} className="flex items-start gap-3 md:gap-6">
          <div className="flex flex-col items-center">
            <div className="relative overflow-hidden">
              <div
                className="text-5xl md:text-8xl lg:text-9xl font-black text-white tabular-nums tracking-tighter transition-all duration-300"
          ...
          {i < blocks.length - 1 && (
            <div className="text-3xl md:text-6xl text-white/20 font-light mt-2 md:mt-4 animate-pulse">
              :
            </div>
          )}
        </div>
