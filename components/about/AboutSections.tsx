...
// ─────────────────────────────────────────────────────────────────────────────
// BEYOND THE COMPETITIONS SECTION
// ─────────────────────────────────────────────────────────────────────────────
export function AboutContentSections() {
  ...
  return (
    <div className="relative w-full bg-transparent text-white selection:bg-purple-500 selection:text-white overflow-hidden">
      {/* ───────────────────────────────────────────────────────────────── */}
      {/* SECTION: BEYOND THE COMPETITIONS                                  */}
      {/* ───────────────────────────────────────────────────────────────── */}
      <section className="relative w-full py-24 sm:py-32 px-6 sm:px-12 md:px-20 bg-[#030206]/70 backdrop-blur-[2px] border-t border-white/10 overflow-hidden select-none">
