  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 bg-surface-container-low border-r border-outline-variant flex flex-col p-6 gap-2 z-40">
      <div className="flex items-center gap-3 mb-8 px-2">
        <img src="/sabrang logo.png" alt="Sabrang Logo" className="w-9 h-9 object-contain" />
        <div className="flex flex-col">
          <h1 className="font-h3 text-h3 font-bold text-primary leading-tight">Sabrang 2026</h1>
          <p className="text-xs text-on-secondary-container opacity-60 font-medium">Festival Admin</p>
        </div>
      </div>
